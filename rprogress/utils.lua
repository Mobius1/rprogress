...
function ErrorCheck(options)
    ...
    for k, v in pairs(options) do
        ...
        if k ~= "onStart" and k ~= "onComplete" then
            if k == "ShowTimer" or k == "ShowProgress" or k == "ShowIncrementer" or k == "Async" or k == "MiniGame" or k == "Loop" then
                if type(v) ~= "boolean" then
                    error = { prop = k, type = "boolean" }
                end              
            elseif k == "Label" or k == "Color" or k == "LabelIncrement" or k == "BGColor" or k == "LabelPosition" or k == "Easing" then
